...
public class Utils {
    ...
    public static String generateRandomConfirmationCode(int length) {
        ...
        for (int i = 0; i < length; i++) {
            int randomIndex = secureRandom.nextInt(ALPHANUMERIC_STRINGS.length());
            char randomChar = ALPHANUMERIC_STRINGS.charAt(randomIndex);
    ...
    public static RoomDTO mapRoomEntityToRoomDTO(Room room) {
        ...
        roomDTO.setRoomDescription(room.getRoomDescription()); // Ensure this field exists in RoomDTO
        return roomDTO;
    }
    ...
    public static UserDTO mapUserEntityToUserDTOPlusUserBookingsAndRoom(User user) {
        ...
        // Ensure user.getBookings() is not null and is iterable
